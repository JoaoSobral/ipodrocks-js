...
Settings is a modal opened from the gear icon (top right). It has two sections: **OpenRouter API** and **Harmonic Analysis**.
...
4. Click **Save** to apply. **Cancel** discards changes.
