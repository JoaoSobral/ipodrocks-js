...
- **Edit Classic playlists** — "Add Ashes to Ashes to Road Trip" or "rename Road Trip to Long Drive". Editing replaces the whole track list, so it asks you to confirm first.
...
- "Make me a playlist with Heroes, Starman and Life on Mars" → looks up each song, creates a Classic playlist
...
4. **Create playlists** — Be specific: "Smart playlist, genre Rock, 50 tracks" or "Genius playlist from my most played, 25 tracks." To hand-pick, just list the song titles and Rocksy builds a Classic playlist.
